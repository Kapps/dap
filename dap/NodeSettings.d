...
/// BUGS:
///		Both get and set operate on snapshots of a value, thus changing the value after setting it will not propogate the changes to this instance.
///		Instead, a copy is saved using MessagePack. This is to work around serialization limitations with no compile-time type information.
final class NodeSettings {
	...
	/**
	 * Returns the current snapshot of the value of the setting with the given name.
	 */
